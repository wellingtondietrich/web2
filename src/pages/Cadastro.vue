        ...
        <v-layout align-center justify-center>
          <v-flex xs12 sm8 md4>
            <v-card class="elevation-12">
              ...
              <v-card-text>
                <v-form>
                  <v-text-field prepend-icon="person" name="login" label="Nome" type="text"></v-text-field>
                  <v-text-field id="password" prepend-icon="lock" name="password" label="Senha" type="password"></v-text-field>
                  <v-text-field id="email" prepend-icon="lock" name="email" label="Email" type="email"></v-text-field>
                </v-form>
              </v-card-text>

              <v-card-actions>
                <v-spacer></v-spacer>
                <v-btn color="primary" @click="$router.push('/dashboard')">Cadastrar</v-btn>
              </v-card-actions>
